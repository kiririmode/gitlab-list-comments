...
export type CiRunner = {
  ...
  /**
   * Availability of upgrades for the runner. Deprecated in 14.10: This feature is in Alpha, and can be removed or changed at any point.
   * @deprecated This feature is in Alpha, and can be removed or changed at any point. Deprecated in 14.10.
   */
  upgradeStatus?: Maybe<CiRunnerUpgradeStatusType>;
  /** Permissions for the current user on the resource */
...
export enum CiRunnerStatus {
   ...
   * @deprecated Use NEVER_CONTACTED instead. NEVER_CONTACTED will have a slightly different scope starting in 15.0, with STALE being returned instead after 3 months of no contact. Deprecated in 14.6.
   */
   ...
   * @deprecated This field will have a slightly different scope starting in 15.0, with STALE being returned after a certain period offline. Deprecated in 14.6.
   */
  OFFLINE = 'OFFLINE',
...
export enum CiRunnerUpgradeStatusType {
...
export type Group = {
  ...
  /** Custom emoji within this namespace. Available only when feature flag `custom_emoji` is enabled. This flag is disabled by default, because the feature is experimental and is subject to change without notice. */
...
export enum IssueSort {
  ...
  /** Status from triggered to resolved. Defaults to `CREATED_DESC` if `incident_escalations` feature flag is disabled. */
  ESCALATION_STATUS_ASC = 'ESCALATION_STATUS_ASC',
  /** Status from resolved to triggered. Defaults to `CREATED_DESC` if `incident_escalations` feature flag is disabled. */
...
export type JobArtifactRegistry = {
  ...
  lastSyncedAt?: Maybe<Scalars['Time']>;
  /** Timestamp after which the JobArtifactRegistry should be resynced */
  retryAt?: Maybe<Scalars['Time']>;
...
export type Mutation = {
  ...
  /** @deprecated Manual iteration management is deprecated. Only automatic iteration cadences will be supported in the future. Deprecated in 14.0. */
  ...
  /** @deprecated Manual iteration management is deprecated. Only automatic iteration cadences will be supported in the future. Deprecated in 14.10. */
...
export enum SecurityPolicyRelationType {
  /** Policies defined for the project only. */
  DIRECT = 'DIRECT',
  /** Policies defined for the project and project's ancestor groups. */
  INHERITED = 'INHERITED'
}
...
export type VulnerabilityFindingDismissInput = {
  ...
  id: Scalars['VulnerabilitiesFindingID'];
};
...
export type MergeRequestIdsQueryVariables = Exact<{
  fullPath: Scalars['ID'];
  targetBranches?: InputMaybe<Array<Scalars['String']> | Scalars['String']>;
  afterMergeRequest?: InputMaybe<Scalars['String']>;
}>;


export type MergeRequestIdsQuery = { __typename?: 'Query', project?: { __typename?: 'Project', id: string, mergeRequests?: { __typename?: 'MergeRequestConnection', pageInfo: { __typename?: 'PageInfo', endCursor?: string | null, hasNextPage: boolean }, edges?: Array<{ __typename?: 'MergeRequestEdge', node?: { __typename?: 'MergeRequest', id: string } | null } | null> | null } | null } | null };

export type MergeRequestCommentsQueryVariables = Exact<{
  mergeRequestId: Scalars['MergeRequestID'];
  discussionAfter?: InputMaybe<Scalars['String']>;
}>;
...
export const MergeRequestIds = gql`
    query mergeRequestIds($fullPath: ID!, $targetBranches: [String!], $afterMergeRequest: String) {
  project(fullPath: $fullPath) {
    ...
    `;
export const MergeRequestComments = gql`
    query mergeRequestComments($mergeRequestId: MergeRequestID!, $discussionAfter: String) {
